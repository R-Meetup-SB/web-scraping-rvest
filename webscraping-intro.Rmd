...
Let us get started with organizing your evenings. The [*Funk Zone*](http://santabarbaraca.com/explore-and-discover-santa-barbara/neighborhoods-towns/santa-barbara/the-funk-zone/) is a pretty fun part of Santa Barbara, where you can find wineries, bars and restaurants. Check this out: <https://santabarbaraca.com/plan-your-trip/wine/wine-shops/>

We are going to scrape the name of the wine shops and their websites out of this webpage and compile this information into a csv, so you will be able to quickly choose where to go to relax next time we can get out!
...
### 2. Use this information to extract the wine shop's names from the webpage:
s
