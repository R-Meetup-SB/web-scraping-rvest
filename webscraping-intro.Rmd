...
Let us get started with organizing your evenings. The [*Funk Zone*](http://santabarbaraca.com/explore-and-discover-santa-barbara/neighborhoods-towns/santa-barbara/the-funk-zone/) is a pretty fun part of Santa Barbara, where you can find wineries, bars and restaurants. Check this out: <https://santabarbaraca.com/plan-your-trip/wine/wine-tasting-rooms/>

We are going to scrape the name of the wine tasting rooms and their websites out of this webpage and compile this information into a csv, so you will be able to quickly choose where to go to relax next time we can get out!
...
### 2. Use this information to extract the wine tasting room's names from the webpage:
s
```{r, message=FALSE, warning=FALSE, error=FALSE}
#install.packages("rvest")
library("rvest")

URL <- "https://santabarbaraca.com/plan-your-trip/wine/wine-tasting-rooms/"

# Read the webpage into R
webpage <- read_html(URL)

# Parse the webpage for bars
wine_room <- html_nodes(webpage, ".listing-title")

# Extract the name of the bar
wine_rooms <- html_text(wine_room)
...
my_wine_tasting <- data.frame(wine_tasting_room = wine_rooms, 
                           website = websites_urls)

# write it to csv
write.csv(my_wine_tasting, "~/data/places_you_will_go.csv", row.names = FALSE)


datatable(my_wine_tasting)
