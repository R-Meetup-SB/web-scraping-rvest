...
knit: (function(input_file, encoding) {
 ...
 encoding=encoding,
 output_file=file.path(dirname(input_file), out_dir, 'webscaping.html'))})
output: 
  html_document:
    theme: "spacelab"
    # df_print: "paged"
...
We are going to scrape the name of the places and their websites out of this webpage and compile this information into a csv, so you will be able to quickly choose where to go to relax next time we can get out!
...
# write it to csv
write.csv(my_cool_bars, "~/data/places_you_will_go.csv", row.names = FALSE)
```
